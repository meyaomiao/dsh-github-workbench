...
async function listIssues(ref, state = "open") {
...
async function listPulls(ref, state = "open") {
...
function IssuesView({ ghRef, onCount, initialDetail, onConsumeDeep }) {
  ...
  const load = (0, import_react4.useCallback)((silent) => {
    if (!silent) {
      setList(null);
    }
    setError(null);
    listIssues(ghRef, stateFilter).then((arr) => {
      setList(arr);
      if (stateFilter === "open") onCount(arr.length);
    }).catch((e) => setError(errText(e)));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-colpane", style: { flex: 1, minHeight: 0, display: "flex" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "gw-open-count", children: list ? `${list.length} ${stateFilter === "open" ? "open" : "closed"}` : "\u2026" }),
...
function PullsView({ ghRef, branches, visible, onCount, initialDetail, onConsumeDeep }) {
  ...
  const load = (0, import_react5.useCallback)((silent) => {
    if (!silent) setList(null);
    setError(null);
    listPulls(ghRef, stateFilter).then((arr) => {
      setList(arr);
      if (stateFilter === "open") onCount(arr.length);
    }).catch((e) => setError(errText(e)));
  }, [ghRef.owner, ghRef.repo, onCount, stateFilter]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-colpane", style: { flex: 1, minHeight: 0, display: "flex" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "gw-open-count", children: list ? `${list.length} ${stateFilter === "open" ? "open" : "closed"}` : "\u2026" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: { display: "flex", gap: 6, alignItems: "center" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-list", children: [
      ...
      list?.map((pr) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("button", { className: "gw-row", onClick: () => setDetail(pr.number), children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          ...
          {
            className: "gw-stateic",
            style: { color: pr.state === "closed" ? "var(--dsw-alias-state-danger-primary)" : pr.draft ? "var(--dsw-alias-label-tertiary)" : "var(--dsw-alias-state-success-primary)" },
            children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(GwIcon, { name: pr.state === "closed" ? "x-circle" : "pr" })
          }
        ),
