...
async function listIssues(ref) {
  const arr = await gh(`/repos/${ghRefKey(ref)}/issues${qs({ state: "open", sort: "updated", per_page: 30 })}`);
  return arr.filter((i) => !i.pull_request);
}
async function getIssue(ref, n) {
  return gh(`/repos/${ghRefKey(ref)}/issues/${n}`);
}
async function listComments(ref, n) {
  return gh(`/repos/${ghRefKey(ref)}/issues/${n}/comments${qs({ per_page: 60 })}`);
}
async function listPulls(ref) {
  return gh(`/repos/${ghRefKey(ref)}/pulls${qs({ state: "open", per_page: 30 })}`);
}
...
async function getMyRepos(force = false) {
  ...
  const arr = await gh("/user/repos?per_page=100&sort=pushed&affiliation=owner,collaborator,organization_member");
  const data = arr.filter((r) => !r.archived).map((r) => ({ fullName: r.full_name, isPrivate: r.private, pushedAt: r.pushed_at, description: r.description, ownerLogin: r.owner?.login ?? "" })).sort((a, b) => b.pushedAt.localeCompare(a.pushedAt));
...
async function listIssuesSince(ref, sinceIso) {
  const arr = await gh(`/repos/${ghRefKey(ref)}/issues${qs({
    state: "all",
    sort: "updated",
    direction: "desc",
    since: sinceIso,
...
async function listPullsSince(ref, sinceIso) {
  return gh(`/repos/${ghRefKey(ref)}/pulls${qs({
    state: "all",
    sort: "updated",
    direction: "desc",
    per_page: 20
...
var AUTO_FOLLOW_KEY = "gw.autoFollow";
function loadAutoFollow() {
  return lsGet(AUTO_FOLLOW_KEY) !== "0";
}
function saveAutoFollow(v) {
  lsSet(AUTO_FOLLOW_KEY, v ? "1" : "0");
}
function loadSubtab() {
...
function IssuesView({ ghRef, onCount, initialDetail, onConsumeDeep }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-colpane", style: { flex: 1, minHeight: 0, display: "flex" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "gw-open-count", children: list ? `${list.length} open` : "\u2026" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "gw-list", children: [
      ...
      list?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Empty, { children: [
        "\u6CA1\u6709\u6253\u5F00\u7684 Issue\u3002",
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("br", {}),
        "\u7528\u4E0A\u65B9\u6309\u94AE\u521B\u5EFA\u7B2C\u4E00\u4E2A\u3002"
      ] }),
      list?.map((it) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { className: "gw-row", onClick: () => setDetail(it.number), children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "gw-stateic", style: { color: "var(--dsw-alias-state-success-primary)" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(GwIcon, { name: "issue" }) }),
        ...
        "button",
        {
          ...
          onClick: () => {
            ...
            createIssue(props.ghRef, title.trim(), body).then((it) => {
              ...
              window.__gwSelfMark?.(`issues:${it.number}`);
...
function PullsView({ ghRef, branches, visible, onCount, initialDetail, onConsumeDeep }) {
  ...
  (0, import_react5.useEffect)(() => {
    ...
    const t = setInterval(reload, sec * 1e3);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-colpane", style: { flex: 1, minHeight: 0, display: "flex" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-toolbar", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "gw-open-count", children: list ? `${list.length} open` : "\u2026" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-list", children: [
      error && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ErrorBox, { msg: error, onRetry: reload }),
      !error && !list && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Loading, {}),
      list?.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Empty, { children: "\u6CA1\u6709\u6253\u5F00\u7684 Pull Request\u3002" }),
      list?.map((pr) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("button", { className: "gw-row", onClick: () => setDetail(pr.number), children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "span",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(GwIcon, { name: "pr" })
          }
        ),
        ...
        "button",
        {
          ...
          onClick: () => {
            ...
            createPull(props.ghRef, { title: title.trim(), body, head: head.trim(), base }).then((pr) => {
              ...
              window.__gwSelfMark?.(`pulls:${pr.number}`);
...
function PullDrawer(props) {
  ...
  const merged = pull.mergeable_state === void 0 ? false : false;
...
\u5C06\u6309 GitHub \u7684\u8BE5\u65B9\u5F0F\u4EA7\u751F\u63D0\u4EA4,\u5408\u5E76\u540E\u901A\u5E38\u81EA\u52A8\u5220\u9664\u6E90\u5206\u652F\u3002`,
    ...
    setBusy(true);
    try {
      window.__gwSelfMark?.(`pulls:${pull.number}`);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { position: "absolute", inset: 0, zIndex: 30, display: "flex" }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-detail", style: { position: "static", flex: 1 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "gw-detail-body", children: [
      pull.body || "(\u65E0\u63CF\u8FF0)",
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CommentsBlock, { ghRef: props.ghRef, number: props.number, comments, onChanged: loadAll })
    ] }),
...
function ActionsView({ ghRef, visible, onCount }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "gw-colpane", style: { flex: 1, minHeight: 0, display: "flex" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "gw-toolbar", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { className: "gw-btn", onClick: reload, children: [
...
var UICtx = (0, import_react7.createContext)({
  confirm: async () => false,
  toast: () => void 0
});
function useUI() {
  return (0, import_react7.useContext)(UICtx);
}
function errText(e) {
...
function WorkbenchApp({ sessionId, visible, seedUrl }) {
  const [repoFull, setRepoFull] = (0, import_react7.useState)(loadRepo());
  const ref = (0, import_react7.useMemo)(() => parseRepoInput(repoFull), [repoFull]);
  const [branch, setBranch] = (0, import_react7.useState)(loadBranch());
  const [subtab, setSubtab] = (0, import_react7.useState)(() => {
  ...
  const [detecting, setDetecting] = (0, import_react7.useState)(false);
  const [reload, setReload] = (0, import_react7.useState)(0);
  const [rate, setRate] = (0, import_react7.useState)(null);
  const [token, setToken] = (0, import_react7.useState)(loadToken());
  const [fontSize, setFontSize] = (0, import_react7.useState)(loadFontSize());
  const [counts, setCounts] = (0, import_react7.useState)({});
  const [repoPop, setRepoPop] = (0, import_react7.useState)(false);
  const [setPop, setSetPop] = (0, import_react7.useState)(false);
  const [deep, setDeep] = (0, import_react7.useState)(null);
  const [autoFollow, setAutoFollowState] = (0, import_react7.useState)(loadAutoFollow());
  const rootRef = (0, import_react7.useRef)(null);
  const [paneW, setPaneW] = (0, import_react7.useState)(0);
  ...
  const seenRef = (0, import_react7.useRef)(/* @__PURE__ */ new Map());
  const baselinedRef = (0, import_react7.useRef)(false);
  const lastSinceRef = (0, import_react7.useRef)(new Date(Date.now() - 15e3).toISOString());
  const selfCoolRef = (0, import_react7.useRef)(/* @__PURE__ */ new Set());
  (0, import_react7.useEffect)(() => {
    ...
    const tick = async () => {
      ...
      try {
        const [issues, pulls, runs] = await Promise.all([
          listIssuesSince(ref, lastSinceRef.current).catch(() => []),
          listPullsSince(ref, lastSinceRef.current).catch(() => []),
          listRuns(ref).then((r) => r.filter((x) => x.created_at >= lastSinceRef.current)).catch(() => [])
        ]);
        const evs = [];
        ...
        const fresh = evs.filter((e) => !seenRef.current.has(e.key)).filter((e) => !window.__gwSelfSet?.has(`${e.tab === "issues" ? "issues" : e.tab}:${e.number ?? ""}`));
        ...
        lastSinceRef.current = (/* @__PURE__ */ new Date()).toISOString();
      }
    };
    tick().then(() => {
      if (dead) return;
  ...
  const switchTab = (0, import_react7.useCallback)((id) => {
    setSubtab(id);
    saveSubtab(id);
  }, []);
  const onCount = (0, import_react7.useCallback)((id) => (n) => {
    setCounts((prev) => prev[id] === n ? prev : { ...prev, [id]: n });
  }, []);
  const [dialog, setDialog] = (0, import_react7.useState)(null);
  const [toasts, setToasts] = (0, import_react7.useState)([]);
  const seq = (0, import_react7.useRef)(0);
  const cleanupFns = (0, import_react7.useRef)([]);
  window.__gwSelfMark = (key) => {
    window.__gwSelfSet?.add(key);
    setTimeout(() => {
      window.__gwSelfSet?.delete(key);
    }, 2e4);
  };
  const ui = (0, import_react7.useMemo)(() => ({
  ...
  const header = /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-header", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "octo", size: 19 }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      "button",
      {
        ...
        title: "\u5207\u6362\u4EE3\u7801\u5E93",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "gw-repo-name", children: repoFull || "\u9009\u62E9\u4ED3\u5E93" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "chevron-down", size: 12, style: { color: "var(--dsw-alias-label-tertiary)" } })
        ]
      }
    ),
    meta?.isPrivate && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "gw-chip", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "lock", size: 9 }),
      "private"
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      "select",
      {
        ...
        children: [
          (branches.length ? branches : meta ? [{ name: meta.defaultBranch }] : []).map((b) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: b.name, children: b.name }, b.name)),
          meta && !branches.some((b) => b.name === meta.defaultBranch) && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: meta.defaultBranch, children: meta.defaultBranch })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      "button",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "external-link", size: 14 })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "gw-hbtn", title: "\u5237\u65B0", onClick: () => setReload((n) => n + 1), children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "refresh", size: 14 }) }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "gw-hbtn", title: "\u8BBE\u7F6E(Token / \u81EA\u52A8\u5237\u65B0)", onClick: () => {
      setSetPop((v) => !v);
      setRepoPop(false);
    }, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "gear", size: 14 }) }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      "span",
      {
  ...
  const body = !ref ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(SetupCard, { detecting, onSubmit: applyRepo, error }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-tabs", children: SUBTABS.map((t) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("button", { className: `gw-tab ${subtab === t.id ? "on" : ""}`, onClick: () => switchTab(t.id), children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: t.icon, size: 13 }),
      t.label,
      counts[t.id] !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "gw-count", children: counts[t.id] })
    ] }, t.id)) }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-body", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      ViewPort,
      {
        subtab,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-footer", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { children: "api.github.com \xB7 REST v3" }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(UICtx.Provider, { value: ui, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    "div",
    {
      ref: rootRef,
      className: "gw-root",
      ...
      children: [
        header,
        body,
        repoPop && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          RepoPopover,
          {
        ...
        setPop && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          SettingsPopover,
          {
            token,
            onSaveToken: (t) => {
        ...
        dialog && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          ConfirmDialog,
          {
            opts: dialog.opts,
            onDone: (v) => {
        ...
        toasts.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-toasts", children: toasts.map((t) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `gw-toast ${t.kind}`, children: t.msg }, t.id)) })
      ]
    }
  ) });
}
function ViewPort(p) {
  switch (p.subtab) {
    case "code":
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(CodeView, { ghRef: p.ghRef, branch: p.branch }, `c:${p.reloadKey}`);
    case "issues":
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(IssuesView, { ghRef: p.ghRef, visible: p.visible, onCount: p.onCount("issues"), initialDetail: p.initialDetail, onConsumeDeep: p.onConsumeDeep }, `i:${p.reloadKey}`);
    case "pulls":
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(PullsView, { ghRef: p.ghRef, branches: p.branches, visible: p.visible, onCount: p.onCount("pulls"), initialDetail: p.initialDetail, onConsumeDeep: p.onConsumeDeep }, `p:${p.reloadKey}`);
    case "actions":
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ActionsView, { ghRef: p.ghRef, visible: p.visible, onCount: p.onCount("actions") }, `a:${p.reloadKey}`);
  }
}
function SetupCard(props) {
  const [value, setValue] = (0, import_react7.useState)("");
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-empty", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { maxWidth: 340, width: "100%" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "octo", size: 40, style: { margin: "0 auto 14px", color: "var(--dsw-alias-label-tertiary)" } }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { marginBottom: 10, lineHeight: 1.7 }, children: props.detecting ? "\u6B63\u5728\u8BC6\u522B\u5F53\u524D\u5DE5\u4F5C\u533A\u7684 GitHub \u4ED3\u5E93\u2026" : "\u8F93\u5165\u8981\u67E5\u770B\u7684\u4ED3\u5E93(owner/repo \u6216\u7C98\u8D34 URL)\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("form", { className: "gw-formrow", onSubmit: (e) => {
      e.preventDefault();
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "gw-btn primary", type: "submit", children: "\u8F7D\u5165" })
    ] }),
    props.error && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-errbox", children: props.error })
  ] }) });
}
function RepoPopover(props) {
  const [value, setValue] = (0, import_react7.useState)("");
  const [repos, setRepos] = (0, import_react7.useState)(null);
  const [loadErr, setLoadErr] = (0, import_react7.useState)(null);
  const [pub, setPub] = (0, import_react7.useState)(null);
  const [searching, setSearching] = (0, import_react7.useState)(false);
  const [hidden, setHidden] = (0, import_react7.useState)(() => loadHiddenRepos());
  const [viewer, setViewer] = (0, import_react7.useState)(null);
  const [manage, setManage] = (0, import_react7.useState)(false);
  const [recent, setRecent] = (0, import_react7.useState)(props.recent);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { ref: wrap, style: { position: "absolute", inset: 0, zIndex: 50 }, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop left", style: { top: 44, position: "absolute", width: "min(380px, calc(100% - 20px))" }, children: !manage ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("form", { className: "gw-formrow", onSubmit: (e) => {
      e.preventDefault();
      submit();
    }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "gw-btn primary", type: "submit", children: "\u5207\u6362" })
    ] }),
    props.recent.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-title", style: { paddingTop: 8 }, children: "\u6700\u8FD1\u4F7F\u7528" }),
      recent.map((full) => {
        const owner = full.split("/")[0];
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "gw-dot" }),
              full,
              full === props.current && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "gw-pop-cur", children: "\u5F53\u524D" }),
              droppable && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                "span",
                {
                  className: "gw-x",
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "trash", size: 10 })
                }
              )
            ]
          },
    ...
    props.hasToken && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-pop-title", style: { paddingTop: 8 }, children: [
        "\u6709\u6743\u9650\u7684\u4ED3\u5E93 \xB7 \u53EF\u89C1 ",
        visibleMine.length,
        "/",
        mineAll.length
      ] }),
      !repos && !loadErr && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-hint", children: "\u62C9\u53D6\u5217\u8868\u2026" }),
      mineFiltered.map((r) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { overflow: "hidden", textOverflow: "ellipsis" }, children: r.fullName }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "gw-meta", style: { marginLeft: "auto", paddingLeft: 8 }, children: timeAgo(r.pushedAt) }),
            canDrop(r) && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "span",
              {
                className: "gw-x",
      ...
      hidden.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-pop-hint", style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { children: [
          "\u5DF2\u9690\u85CF ",
          hidden.length,
          " \u4E2A\u975E\u672C\u4EBA\u4ED3\u5E93"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "gw-btn", style: { padding: "1px 8px" }, onClick: () => setManage(true), children: "\u7BA1\u7406" })
      ] })
    ] }),
    loadErr && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-errbox", children: loadErr }),
    !props.hasToken && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-hint", children: "\u{1F4A1} \u5728 \u2699 \u586B Token \u540E\u81EA\u52A8\u5217\u51FA\u4F60\u6709\u6743\u9650\u7684\u4ED3\u5E93\u3002" }),
    (q.length >= 3 || searching) && !manage && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-pop-title", style: { paddingTop: 8 }, children: [
        "\u516C\u5F00\u4ED3\u5E93\u641C\u7D22\u300C",
        q,
        "\u300D"
      ] }),
      searching && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-hint", children: "\u641C\u7D22\u4E2D\u2026" }),
      !searching && pub && pub.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-hint", children: "\u65E0\u7ED3\u679C\u3002" }),
      (pub ?? []).map((r) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
        "button",
        {
          ...
          title: r.description ?? r.fullName,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "octo", size: 11, style: { color: "var(--dsw-alias-label-tertiary)" } }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { overflow: "hidden", textOverflow: "ellipsis" }, children: r.fullName }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "gw-meta", style: { marginLeft: "auto", paddingLeft: 8 }, children: [
              "\u2B50 ",
              r.stars
            ] })
          ]
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-hint", children: "\u63D0\u793A:\u56DE\u8F66\u6309\u8F93\u5165\u5185\u5BB9\u89E3\u6790\u4E3A owner/repo\u3002" })
    ] })
  ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-pop-title", children: [
      "\u5DF2\u9690\u85CF\u7684\u4ED3\u5E93(",
      hidden.length,
      ")\u2014\u2014 \u4EC5\u4ECE\u672C\u5217\u8868\u79FB\u9664,\u4E0D\u5F71\u54CD GitHub"
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { maxHeight: 240, overflow: "auto" }, children: [
      hidden.map((full) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("button", { className: "gw-pop-item", onClick: () => {
        unhideRepo(full);
        setHidden(loadHiddenRepos());
      }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(GwIcon, { name: "plus", size: 10 }),
        full,
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "gw-pop-cur", children: "\u6062\u590D" })
      ] }, full)),
      hidden.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-hint", children: "\u7A7A\u3002" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-formrow", style: { justifyContent: "flex-end", paddingTop: 6 }, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "gw-btn", onClick: () => setManage(false), children: "\u8FD4\u56DE\u5217\u8868" }) })
  ] }) }) });
}
function SettingsPopover(props) {
  const [tok, setTok] = (0, import_react7.useState)(props.token);
  const [autoSec, setAutoSec] = (0, import_react7.useState)(loadAutoRefreshSec());
  const [fontSel, setFontSel] = (0, import_react7.useState)(props.fontSize);
  const [follow, setFollow] = (0, import_react7.useState)(props.autoFollow);
  const wrap = (0, import_react7.useRef)(null);
  (0, import_react7.useEffect)(() => {
    const close = (e) => {
      if (!(e.target instanceof Node) || !wrap.current?.contains(e.target)) props.onClose();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { ref: wrap, style: { position: "absolute", inset: 0, zIndex: 50 }, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-pop right", style: { top: 44, position: "absolute" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-pop-title", children: "GitHub \u8BBF\u95EE\u4EE4\u724C(Personal Access Token)" }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-field", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      "input",
      {
        className: "gw-input",
        type: "password",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { children: "PR / Actions \u81EA\u52A8\u5237\u65B0\u5468\u671F(\u79D2,0 = \u5173\u95ED)" }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        "input",
        {
          className: "gw-input",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-field", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("input", { type: "checkbox", checked: follow, onChange: (e) => setFollow(e.target.checked) }),
      "\u81EA\u52A8\u8DDF\u968F\u4ED3\u5E93\u6D3B\u52A8(\u65B0 Issue/PR/CI \u65F6\u81EA\u52A8\u6253\u5F00\u5BF9\u5E94\u9875\u7B7E)"
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { children: "\u6B63\u6587\u5B57\u53F7(Issue / PR \u5217\u8868\u4E0E\u8BE6\u60C5)" }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
        "select",
        {
          className: "gw-input",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "dsh", children: "\u8DDF\u968F DSH \u4FA7\u8FB9\u680F(12px,\u9ED8\u8BA4)" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "13", children: "13 px(\u7D27\u51D1)" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "14", children: "14 px" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("option", { value: "14", children: "14 px(\u5927)" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-formrow", style: { justifyContent: "flex-end", paddingTop: 6 }, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "gw-btn primary", onClick: () => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-pop-hint", children: [
      "\u7EC6\u7C92\u5EA6 Token \u6743\u9650:Contents(R)\u3001Issues(RW)\u3001Pull requests(RW)\u3001Actions(RW); \u7ECF\u5178 Token \u7528 ",
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("code", { children: "repo" }),
      "\u3002\u4EC5\u4FDD\u5B58\u5728\u672C\u6D4F\u89C8\u5668,\u4E0D\u7ECF\u8FC7\u4EFB\u4F55\u670D\u52A1\u7AEF\u3002"
    ] })
  ] }) });
}
function ConfirmDialog(props) {
  const { opts } = props;
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "gw-scrim", onMouseDown: (e) => {
    if (e.target === e.currentTarget) props.onDone(false);
  }, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-dialog", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h4", { children: opts.title }),
    opts.body && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { children: opts.body }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "gw-dialog-actions", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { className: "gw-btn", onClick: () => props.onDone(false), children: "\u53D6\u6D88" }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        "button",
        {
...
function mountAsTab(ctx, registry) {
  const descriptor = {
    ...
    component: (props) => (0, import_react8.createElement)(WorkbenchApp, {
...
function mountStandalone() {
  ...
  function render() {
    state.root.render((0, import_react8.createElement)(WorkbenchApp, {
      sessionId: "",
