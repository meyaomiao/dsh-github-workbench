...
function IssuesView({ ghRef, onCount }) {
  const ui = useUI();
...
function PullsView({ ghRef, branches, visible, onCount }) {
  const ui = useUI();
...
function WorkbenchApp({ sessionId, visible }) {
...
function ViewPort(p) {
  switch (p.subtab) {
    ...
    case "issues":
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(IssuesView, { ghRef: p.ghRef, visible: p.visible, onCount: p.onCount("issues") }, `i:${p.reloadKey}`);
    case "pulls":
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(PullsView, { ghRef: p.ghRef, branches: p.branches, visible: p.visible, onCount: p.onCount("pulls") }, `p:${p.reloadKey}`);
    case "actions":
